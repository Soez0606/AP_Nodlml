...
<body>
  ...
  <p>Le site <strong>NoodleML</strong> (<a href="/">https://noodleml.com</a>) respecte votre vie privée. Cette page a pour but de vous expliquer quelles données sont collectées, pourquoi, et comment vous pouvez les contrôler.</p>
